"""
SafeOpsAI — Scoring Agent: Configuration
==========================================
...
API_PORT                8003
LOG_LEVEL               INFO
CONFIG_FILE             /app/scoring_agent/config.yml
"""
...
class AgentConfig:
    ...
    def min_candidates(self) -> int:
        return int(self._raw.get("candidates", {}).get("min_candidates", 3))

    @property
    def max_candidates(self) -> int:
        return int(self._raw.get("candidates", {}).get("max_candidates", 6))
