...
async def _main() -> None:
    ...
    polling_task = asyncio.create_task(run_agent(), name="rca-polling")
    ...
    server_task = asyncio.create_task(server.serve(), name="rca-api")

    log.info("Root Cause Agent running — API on http://%s:%s", API_HOST, API_PORT)
